...
- Запись веса один раз в день; принимает числа в любом формате: `75`, `75.3`, `75,3`
- Просмотр истории взвешиваний и график динамики веса с линией среднего значения
- Запись давления утром и вечером: `120/80`, `120-80`, `120 80`, `120/80/70` (с пульсом)
  - Утро: 05:00–14:59, вечер: 15:00–04:59 — период определяется автоматически
- График давления: отдельные линии для утреннего и вечернего верхнего/нижнего давления и пульса
...
├── chart.py             # построение графиков (вес и давление)
